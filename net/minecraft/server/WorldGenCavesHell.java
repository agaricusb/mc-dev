...
public class WorldGenCavesHell extends WorldGenBase
{
     ...
     */
    protected void a(int par1, int par2, byte[] par3ArrayOfByte, double par4, double par6, double par8)
    {
        this.a(par1, par2, par3ArrayOfByte, par4, par6, par8, 1.0F + this.b.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
    }

    /**
     * Generates a node in the current cave system recursion tree.
     */
    protected void a(int par1, int par2, byte[] par3ArrayOfByte, double par4, double par6, double par8, float par10, float par11, float par12, int par13, int par14, double par15)
    {
        ...
        for (boolean var26 = var23.nextInt(6) == 0; par13 < par14; ++par13)
        {
            ...
            {
                this.a(par1, par2, par3ArrayOfByte, par4, par6, par8, var23.nextFloat() * 0.5F + 0.5F, par11 - ((float) Math.PI / 2F), par12 / 3.0F, par13, par14, 1.0D);
                this.a(par1, par2, par3ArrayOfByte, par4, par6, par8, var23.nextFloat() * 0.5F + 0.5F, par11 + ((float) Math.PI / 2F), par12 / 3.0F, par13, par14, 1.0D);
                return;
            }
            ...
            if (var51 || var23.nextInt(4) != 0)
            {
                ...
                {
                    int var52 = MathHelper.floor(par4 - var27) - par1 * 16 - 1;
                    int var34 = MathHelper.floor(par4 + var27) - par1 * 16 + 1;
                    int var53 = MathHelper.floor(par6 - var29) - 1;
                    int var36 = MathHelper.floor(par6 + var29) + 1;
                    int var55 = MathHelper.floor(par8 - var27) - par2 * 16 - 1;
                    int var38 = MathHelper.floor(par8 + var27) - par2 * 16 + 1;
                    ...
                    for (var40 = var52; !var54 && var40 < var34; ++var40)
                    {
                        for (int var41 = var55; !var54 && var41 < var38; ++var41)
                        {
                            for (int var42 = var36 + 1; !var54 && var42 >= var53 - 1; --var42)
                            {
                                ...
                                {
                                    if (par3ArrayOfByte[var43] == Block.LAVA.id || par3ArrayOfByte[var43] == Block.STATIONARY_LAVA.id)
                                    {
                                        var54 = true;
                                    }
    ...
    protected void a(World par1World, int par2, int par3, int par4, int par5, byte[] par6ArrayOfByte)
    {
        ...
        for (int var8 = 0; var8 < var7; ++var8)
        {
            ...
            {
                this.a(par4, par5, par6ArrayOfByte, var9, var11, var13);
            ...
            for (int var16 = 0; var16 < var15; ++var16)
            {
                ...
                this.a(par4, par5, par6ArrayOfByte, var9, var11, var13, var19 * 2.0F, var17, var18, 0, 0, 0.5D);
            }
        }
    }
}
