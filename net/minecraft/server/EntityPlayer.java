...
public class EntityPlayer extends EntityHuman implements ICrafting
{
    ...
    public EntityPlayer(MinecraftServer par1MinecraftServer, World par2World, String par3Str, PlayerInteractManager par4ItemInWorldManager)
    {
        super(par2World);
        par4ItemInWorldManager.player = this;
        this.playerInteractManager = par4ItemInWorldManager;
        this.cq = par1MinecraftServer.getPlayerList().o();
    ...
    public void g()
    {
        ...
        for (int var1 = 0; var1 < this.inventory.getSize(); ++var1)
        {
            ...
            if (var2 != null && Item.byId[var2.id].f() && this.playerConnection.lowPriorityCount() <= 5)
            {
    ...
    {
        this.server.getPlayerList().k(par1DamageSource.getLocalizedDeathMessage(this));
    ...
    public boolean damageEntity(DamageSource par1DamageSource, int par2)
    {
        ...
        else
        {
            ...
            if (!var3 && this.invulnerableTicks > 0 && par1DamageSource != DamageSource.OUT_OF_WORLD)
            {
                return false;
            }
            else
    ...
    public void b(int par1)
    {
        ...
        else
        {
            if (this.dimension == 1 && par1 == 0)
            {
                ...
                if (var2 != null)
                {
                    this.playerConnection.a((double) var2.x, (double) var2.y, (double) var2.z, 0.0F, 0.0F);
                }
            ...
            this.server.getPlayerList().changeDimension(this, par1);
            this.lastSentExp = -1;
            this.cl = -1;
            this.cm = -1;
        }
    ...
    public EnumBedResult a(int par1, int par2, int par3)
    {
        ...
        if (var4 == EnumBedResult.OK)
        {
            ...
            this.playerConnection.sendPacket(var5);
        }
    ...
    public void openContainer(IInventory par1IInventory)
    {
        ...
        this.nextContainerCounter();
        this.playerConnection.sendPacket(new Packet100OpenWindow(this.containerCounter, 0, par1IInventory.getName(), par1IInventory.getSize()));
    ...
    {
        this.nextContainerCounter();
        this.playerConnection.sendPacket(new Packet100OpenWindow(this.containerCounter, 2, par1TileEntityFurnace.getName(), par1TileEntityFurnace.getSize()));
    ...
    {
        this.nextContainerCounter();
        this.playerConnection.sendPacket(new Packet100OpenWindow(this.containerCounter, 3, par1TileEntityDispenser.getName(), par1TileEntityDispenser.getSize()));
    ...
    {
        this.nextContainerCounter();
        this.playerConnection.sendPacket(new Packet100OpenWindow(this.containerCounter, 5, par1TileEntityBrewingStand.getName(), par1TileEntityBrewingStand.getSize()));
    ...
    {
        this.nextContainerCounter();
        this.playerConnection.sendPacket(new Packet100OpenWindow(this.containerCounter, 7, par1TileEntityBeacon.getName(), par1TileEntityBeacon.getSize()));
    ...
    public void openTrade(IMerchant par1IMerchant)
    {
        ...
        this.playerConnection.sendPacket(new Packet100OpenWindow(this.containerCounter, 6, var2.getName(), var2.getSize()));
        ...
        if (var3 != null)
        {
            try
            {
                ...
                var3.a(var5);
                this.playerConnection.sendPacket(new Packet250CustomPayload("MC|TrList", var4.toByteArray()));
            }
    ...
    public void a(Container par1Container, int par2, ItemStack par3ItemStack)
    {
        if (!(par1Container.getSlot(par2) instanceof SlotResult))
        {
            if (!this.h)
            {
                this.playerConnection.sendPacket(new Packet103SetSlot(par1Container.windowId, par2, par3ItemStack));
            }
        }
    }
    ...
    {
        this.playerConnection.sendPacket(new Packet104WindowItems(par1Container.windowId, par2List));
    ...
    {
        this.playerConnection.sendPacket(new Packet105CraftProgressBar(par1Container.windowId, par2, par3));
    }
    ...
    public void a(Statistic par1StatBase, int par2)
    {
        if (par1StatBase != null)
        {
            if (!par1StatBase.f)
            {
                while (par2 > 100)
                {
                    this.playerConnection.sendPacket(new Packet200Statistic(par1StatBase.e, 100));
                    par2 -= 100;
                }

                this.playerConnection.sendPacket(new Packet200Statistic(par1StatBase.e, par2));
            }
        }
    }
    ...
    public void b(String par1Str)
    {
        ...
        this.playerConnection.sendPacket(new Packet3Chat(var3));
    }
    ...
    public void a(ItemStack par1ItemStack, int par2)
    {
        ...
        if (par1ItemStack != null && par1ItemStack.getItem() != null && par1ItemStack.getItem().b_(par1ItemStack) == EnumAnimation.b)
        {
    ...
    protected void a(MobEffect par1PotionEffect)
    {
        ...
        this.playerConnection.sendPacket(new Packet41MobEffect(this.id, par1PotionEffect));
    }
    ...
    protected void c(MobEffect par1PotionEffect)
    {
        ...
        this.playerConnection.sendPacket(new Packet42RemoveMobEffect(this.id, par1PotionEffect));
    }
    ...
    {
        this.playerConnection.a(par1, par3, par5, this.yaw, this.pitch);
    }
    ...
    {
        this.playerInteractManager.setGameMode(par1EnumGameType);
        this.playerConnection.sendPacket(new Packet70Bed(3, par1EnumGameType.a()));
    }

    public void sendMessage(String par1Str)
    {
        this.playerConnection.sendPacket(new Packet3Chat(par1Str));
    }
    ...
    {
        return "seed".equals(par2Str) && !this.server.T() ? true : (!"tell".equals(par2Str) && !"help".equals(par2Str) && !"me".equals(par2Str) ? this.server.getPlayerList().isOp(this.name) : true);
    }
    ...
    public void a(Packet204LocaleAndViewDistance par1Packet204ClientInfo)
    {
        ...
        this.cr = par1Packet204ClientInfo.g();
        this.cs = par1Packet204ClientInfo.h();
    ...
    public void a(String par1Str, int par2)
    {
        ...
        this.playerConnection.sendPacket(new Packet250CustomPayload("MC|TPack", var3.getBytes()));
    }
