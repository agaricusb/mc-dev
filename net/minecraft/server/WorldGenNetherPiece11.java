...
{
    public WorldGenNetherPiece11(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        super(par1);
        this.f = par4;
    ...
    public void a(StructurePiece par1StructureComponent, List par2List, Random par3Random)
    {
        ...
        this.a((WorldGenNetherPiece15) par1StructureComponent, par2List, par3Random, 5, 11, true);
    }

    /**
     * Creates and returns a new component piece. Or null if it could not find enough room to place it.
     */
    public static WorldGenNetherPiece11 a(List par0List, Random par1Random, int par2, int par3, int par4, int par5, int par6)
    {
        StructureBoundingBox var7 = StructureBoundingBox.a(par2, par3, par4, -5, -3, 0, 13, 14, 13, par5);
        return a(var7) && StructurePiece.a(par0List, var7) == null ? new WorldGenNetherPiece11(par6, par1Random, var7, par5) : null;
    }
    ...
    public boolean a(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        var4 = this.c(Block.NETHER_BRICK_STAIRS.id, 3);
        int var5;
        int var6;
        int var7;
        ...
        for (var5 = 0; var5 <= 6; ++var5)
        {
            ...
            {
                this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var4, var7, 5 + var5, var6, par3StructureBoundingBox);
            }

            if (var6 >= 5 && var6 <= 8)
            {
                this.a(par1World, par3StructureBoundingBox, 5, 5, var6, 7, var5 + 4, var6, Block.NETHER_BRICK.id, Block.NETHER_BRICK.id, false);
            }
            else if (var6 >= 9 && var6 <= 10)
            {
                this.a(par1World, par3StructureBoundingBox, 5, 8, var6, 7, var5 + 4, var6, Block.NETHER_BRICK.id, Block.NETHER_BRICK.id, false);
            }

            if (var5 >= 1)
            {
                this.a(par1World, par3StructureBoundingBox, 5, 6 + var5, var6, 7, 9 + var5, var6, 0, 0, false);
            }
        }

        for (var5 = 5; var5 <= 7; ++var5)
        {
            this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var4, var5, 12, 11, par3StructureBoundingBox);
        }

        this.a(par1World, par3StructureBoundingBox, 5, 6, 7, 5, 7, 7, Block.NETHER_FENCE.id, Block.NETHER_FENCE.id, false);
        this.a(par1World, par3StructureBoundingBox, 7, 6, 7, 7, 7, 7, Block.NETHER_FENCE.id, Block.NETHER_FENCE.id, false);
        this.a(par1World, par3StructureBoundingBox, 5, 13, 12, 7, 13, 12, 0, 0, false);
        this.a(par1World, par3StructureBoundingBox, 2, 5, 2, 3, 5, 3, Block.NETHER_BRICK.id, Block.NETHER_BRICK.id, false);
        this.a(par1World, par3StructureBoundingBox, 2, 5, 9, 3, 5, 10, Block.NETHER_BRICK.id, Block.NETHER_BRICK.id, false);
        this.a(par1World, par3StructureBoundingBox, 2, 5, 4, 2, 5, 8, Block.NETHER_BRICK.id, Block.NETHER_BRICK.id, false);
        this.a(par1World, par3StructureBoundingBox, 9, 5, 2, 10, 5, 3, Block.NETHER_BRICK.id, Block.NETHER_BRICK.id, false);
        this.a(par1World, par3StructureBoundingBox, 9, 5, 9, 10, 5, 10, Block.NETHER_BRICK.id, Block.NETHER_BRICK.id, false);
        this.a(par1World, par3StructureBoundingBox, 10, 5, 4, 10, 5, 8, Block.NETHER_BRICK.id, Block.NETHER_BRICK.id, false);
        var5 = this.c(Block.NETHER_BRICK_STAIRS.id, 0);
        var6 = this.c(Block.NETHER_BRICK_STAIRS.id, 1);
        this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var6, 4, 5, 2, par3StructureBoundingBox);
        this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var6, 4, 5, 3, par3StructureBoundingBox);
        this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var6, 4, 5, 9, par3StructureBoundingBox);
        this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var6, 4, 5, 10, par3StructureBoundingBox);
        this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var5, 8, 5, 2, par3StructureBoundingBox);
        this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var5, 8, 5, 3, par3StructureBoundingBox);
        this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var5, 8, 5, 9, par3StructureBoundingBox);
        this.a(par1World, Block.NETHER_BRICK_STAIRS.id, var5, 8, 5, 10, par3StructureBoundingBox);
        this.a(par1World, par3StructureBoundingBox, 3, 4, 4, 4, 4, 8, Block.SOUL_SAND.id, Block.SOUL_SAND.id, false);
        this.a(par1World, par3StructureBoundingBox, 8, 4, 4, 9, 4, 8, Block.SOUL_SAND.id, Block.SOUL_SAND.id, false);
        this.a(par1World, par3StructureBoundingBox, 3, 5, 4, 4, 5, 8, Block.NETHER_WART.id, Block.NETHER_WART.id, false);
        this.a(par1World, par3StructureBoundingBox, 8, 5, 4, 9, 5, 8, Block.NETHER_WART.id, Block.NETHER_WART.id, false);
        ...
        for (var7 = 4; var7 <= 8; ++var7)
        {
            ...
            {
                this.b(par1World, Block.NETHER_BRICK.id, 0, var7, -1, var8, par3StructureBoundingBox);
                this.b(par1World, Block.NETHER_BRICK.id, 0, var7, -1, 12 - var8, par3StructureBoundingBox);
            }
        }
        ...
        for (var7 = 0; var7 <= 2; ++var7)
        {
            ...
            {
                this.b(par1World, Block.NETHER_BRICK.id, 0, var7, -1, var8, par3StructureBoundingBox);
                this.b(par1World, Block.NETHER_BRICK.id, 0, 12 - var7, -1, var8, par3StructureBoundingBox);
            }
        }
