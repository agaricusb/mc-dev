...
public class WorldGenVillageFarm extends WorldGenVillagePiece
{
    ...
    public WorldGenVillageFarm(WorldGenVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static WorldGenVillageFarm a(WorldGenVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.a(par3, par4, par5, 0, 0, 0, 7, 4, 9, par6);
        return a(var8) && StructurePiece.a(par1List, var8) == null ? new WorldGenVillageFarm(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
    }
    ...
    public boolean a(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.a(par1World, par3StructureBoundingBox, 1, 0, 0, 5, 0, 0, Block.LOG.id, Block.LOG.id, false);
        this.a(par1World, par3StructureBoundingBox, 1, 0, 8, 5, 0, 8, Block.LOG.id, Block.LOG.id, false);
